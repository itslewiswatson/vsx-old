...
function onEditBuy() {
	...
	var val = document.getElementById("buy").value; // Not casted to a number
	...
	if (document.getElementById("buy").value.replace(" ", "") == "") {
		document.getElementById("buy-text").innerHTML = "";
	}

	var price = val2 * stockPrice;
	price = (price).formatMoney(2);
	document.getElementById("buy-text").innerHTML = "You will cost you <strong>$" + price + "</strong>";
	document.getElementById("buy").value = tocomma(val2);
}
